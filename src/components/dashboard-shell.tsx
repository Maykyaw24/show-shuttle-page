...
export function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="relative border-b border-border/60 bg-background/80 backdrop-blur sticky top-0 z-30">
          ...
          {nav && nav.length > 0 && (
            <>
              ...
              <button
                ...
                className="md:hidden p-2 rounded-lg hover:bg-muted transition shrink-0"
        ...
        {menuOpen && nav && (
          <nav className="md:hidden absolute top-full left-0 right-0 border-b border-border/60 bg-background/95 backdrop-blur shadow-lg">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-col gap-1">
              {nav.map((n) => (
                <Link
                  ...
                  activeProps={{ className: "px-3 py-2 rounded-lg bg-muted text-foreground" }}
                  activeOptions={{ exact: true }}
                >
                  {n.label}
                </Link>
